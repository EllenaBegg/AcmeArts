            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p>Please edit the input values and submit to update artist record.</p>
                        ...
                        <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="yearborn" class="form-control <?php echo (!empty($yearborn_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $yearborn; ?>">
                                <span class="invalid-feedback"><?php echo $yearborn_err; ?></span>
                            </div>      												
                            <div class="form-group">
                                <label>Year Death</label>
                                <input type="text" name="yeardeath" class="form-control <?php echo (!empty($yeardeath_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $yeardeath; ?>">
