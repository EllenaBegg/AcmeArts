    ...
    if (empty($title_err) && empty($year_err)) {
        try {
            ...
            if ($is_thumbnail && $is_image) {
                $sql = "UPDATE Painting SET Title=?,Year=?,ArtistId=?,ArtStyleId=?,MediumId=?,Thumbnail=?,Image=? WHERE Title=?";
                ...
                $sql = "UPDATE Painting SET Title=?,Year=?,ArtistId=?,ArtStyleId=?,MediumId=?,Thumbnail=? WHERE Title=?";
                if ($stmt = $pdo->prepare($sql)) {
                ...
                $sql = "UPDATE Painting SET Title=?,Year=?,ArtistId=?,ArtStyleId=?,MediumId=?,Image=? WHERE Title=?";
                if ($stmt = $pdo->prepare($sql)) {
                ...
                $sql = "UPDATE Painting SET Title=?,Year=?,ArtistId=?,ArtStyleId=?,MediumId=? WHERE Title=?";
                if ($stmt = $pdo->prepare($sql)) {
