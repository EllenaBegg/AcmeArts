                                    ...
                                    try {
                                        ...
                                        if ($result->rowCount() > 0) {
                                            while ($row = $result->fetch()) {
                                                echo '<option value="' . $row["Id"] . "-" . $row["ArtistName"] . '">' . $row["Id"] . "-" . $row["ArtistName"] . '</option>';
                                            }
                                            unset($result);
                                        }
                                    } catch (PDOException $e) {
                            ...
                            <select name="style" class="form-select">
                                ...
                                if (empty($style)) {
                                    try {
                                        ...
                                        if ($result->rowCount() > 0) {
                                            while ($row = $result->fetch()) {
                                                echo '<option value="' . $row["Id"] . "-" . $row["ArtStyle"] . '">' . $row["Id"] . "-" . $row["ArtStyle"] . '</option>';
                                            }
                                            unset($result);
                                        }
                                    } catch (PDOException $e) {
                            ...
                            <select name="media" class="form-select">							
                                ...
                                if (empty($media)) {
                                    try {
                                        ...
                                        if ($result->rowCount() > 0) {
                                            while ($row = $result->fetch()) {
                                                echo '<option value="' . $row["Id"] . "-" . $row["Medium"] . '">' . $row["Id"] . "-" . $row["Medium"] . '</option>';
                                            }
                                            unset($result);
                                        }
                                    } catch (PDOException $e) {
